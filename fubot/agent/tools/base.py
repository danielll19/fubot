...
class Tool(ABC):
    ...
    def name(self) -> str:
        ...
        raise RuntimeError("Tool.name must be implemented by subclasses")

    @property
    @abstractmethod
    def description(self) -> str:
        """Description of what the tool does."""
        raise RuntimeError("Tool.description must be implemented by subclasses")

    @property
    @abstractmethod
    def parameters(self) -> dict[str, Any]:
        """JSON Schema for tool parameters."""
        raise RuntimeError("Tool.parameters must be implemented by subclasses")
    ...
    async def execute(self, **kwargs: Any) -> str:
        ...
        """
        raise RuntimeError("Tool.execute() must be implemented by subclasses")
